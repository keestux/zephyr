...
The Sodaq Zero is a maker-friendly development board with
...
The `Sodaq store`_ has detailed information about board
connections. Download the `Sodaq Zero Schematic`_ for more detail.
...
The SAMD21 MCU has 6 SERCOM based SPIs.  On the Sodaq Zero, SERCOM4
...
The Sodaq Zero comes with a Atmel Embedded Debugger (EDBG).  This
...
#. Connect the Sodaq Zero to your host computer using the USB debug
   port.
